...
public class MainActivity extends AppCompatActivity {
    ...
    public void voiceInput(View view){
        ...
        NotificationCompat.Action.Builder notificationActionBuilder = new NotificationCompat.Action.Builder(R.drawable.ic_launcher_background, "My voice" , viewPendingIntent);
        ...
        NotificationCompat.Builder  NotificationBuilder = new NotificationCompat.Builder(this , NOTIFICATION_CHANNEL_ID);
        NotificationBuilder.setAutoCancel(true).setSmallIcon(R.drawable.ic_launcher_background).setContentTitle("My Notification").setContentText("Hello from here").setContentInfo("info")
